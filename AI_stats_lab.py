...
def diabetes_linear_pipeline():
    ...
    # Comments: 
    # 1. Overfitting check: compare train_r2 vs test_r2. 
    # If train_r2 >> test_r2, the model is overfitting. 
    # 2. Feature scaling: ensures features contribute fairly to model  and improves coefficient stability.
...
def cancer_cross_validation():
    ...
    # Cross-validation reduces evaluation variance and provides a more reliable estimate of model performance.
